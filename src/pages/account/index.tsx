      ...
      <div className="container">
        ...
        <div className="flex-col sm:flex sm:flex-row sm:gap-[102px]">
          <div className="bg-[#F3F5F7] md:w-[262px] p-10">
            <div className="flex relative flex-col justify-center items-center">
              <div className="mb-5">
                <img
                  ...
                  alt=""
                />
                <span className="bg-black rounded-full border-2 border-white w-8 h-8 flex justify-center absolute top-[60px] right-23 sm:right-13">
            ...
            <div className="mt-12">
              {isSmall === false ? (
                ...
                <div>
                  <select
                    className="w-full text-[#6C7275] text-[18px]"
                    onChange={(e) => {
                      const value = e.target.value;
                      if (value === "account") setShowAddress(false);
                      if (value === "address") setShowAddress(true);
          ...
          <div className="flex flex-col mt-20 mb-20 sm:mt-0 sm:mb-0">
            {!showAddress ? (
              <div className="shadow-lg  md:w-[707px] p-10">
